...
SPEAKERS =   [
  ...
  {:email => 'gabriel.sobrinho@gmail.com', :name => 'Gabriel Sobrinho', :company => 'hohup.com.br', :bio => %(Sócio desenvolvedor da nohup. Se alguém encontrar uma insulina, favor entrar em contato...), :talk => 'Pesquisa fonética', :desc => %(Aplicando o algoritmo BuscaBR)},
