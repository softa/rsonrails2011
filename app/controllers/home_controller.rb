...
SPEAKERS =   [
  {:email => 'alvaro@cuboxsa.com', :name => 'Alvaro Gil', :company => 'cuboxsa.com', :bio => %("Alvaro is a Developer and UI Designer passionate about programming and agile methodologies. His past work include technologies such as  C++ and .NET in the fields of CG and GIS. He's now happy to have  settled on Ruby, working at Cubox, developing web apps and pushing  forward web technologies everyday"), :image => '/images/CB.png', :talk => 'Developer and client interactions: Deliver quality work while avoiding frustrations', :desc => %(Alvaro will talk about his experiences working with different kinds of clients and projects. How to deal with day by day programming work, manage frustrations and deal with the client's expectations from a remote developer's point of view.)},
...
#  {:email => 'daniel@egenial.com.br', :name => 'Daniel Lopes', :company => 'objetiva.co', :bio => %(É sócio fundador da Objetiva Software e está envolvido com TI há quase uma década. Trabalha como desenvolvedor web com grande interesse em Ruby/TDD/Javascript e Frontend. Também é instrutor de treinamentos presenciais e online em parceria com a Egenial com mais de 500 alunos treinados em assuntos como Ruby e Rails. Também ministra a disciplina de Desenvolvimento Web em Pós Graduação na UNA e frequentemente participa da organização de eventos como Ruby Masters, Café Com TOM e Kata TOM. Formalmente é técnico e bacharel em Sistemas de Informação.), :talk => 'Aguardando', :desc => %(Aguardando)},
  ...
  {:email => 'narwen@gmail.com', :name => 'Thais Camilo', :company => 'hashrocket.com', :bio => %(O caminho que levou Thais a se apaixonar por Ruby on Rails começou com seu aprendizado de Perl para organizar usa extensa coleção de livros e musicas. Isso rapidamente levou-a a buscar o grau de Bacharel em ciências da computação (ao invés de seguir com os negócios da família) e a trabalhar com desenvolvimento de software em C, Perl, Python e PHP. Ela então partiu para explorar Java até finalmente encontrar (e se apaixonar por) o Ruby on Rails. Brasileira, mudou-se para o Chile para se tornar uma Rocketeer e sentir a neve pela primeira vez nos Andes. Ela ama ajudar os outros, nunca contendo-se a ensinar o necessário a quem quer se seja. No seu tempo livre ela gosta de andar de bike, correr e praticar Krav Magá. Apesar de se uma praticante de Krav Magá, ela jura ser uma pessoa gentil. Ah, não se assuste se ela o abraçar na primeira vez que te conhecer.), :image => '/images/thais.jpg', :talk => 'Cuking it Right', :desc => %(Muitas desenvolvedores ainda não gostam ou não entendem como Cucumber pode ser uma ferramenta poderosa no desenvolvimento de software. Alguns meses atrás eu tinha a mesma opinião. Meu objetivo com essa palestra é explicar detalhes, truques e outras ferramentas que uma vez integradas mudaram minha opinião sobre Cucumber e eu espero conseguir mudar a sua.)}]
